...
const DropdownCustom = () => {
  ...
  return (
    <div className="relative">
      <div
        className="inline-flex cursor-pointer items-center overflow-hidden rounded-md bg-white"
        onClick={() => setOpen(!open)}
      >
        <p className="px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 hover:text-gray-700">
          My Open Leads
        </p>
